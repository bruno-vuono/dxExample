...
if((UserInfo.getProfileId()!='00eM0000000QNYPIA4') && (UserInfo.getProfileId()!= '00eD0000001AnFlIAK')) {
    ...
    if ( lstSubChannelId.size() > 0 )
    {
        ...
        for(UDC__c subChannel : LAT_QueriesCacheHelper.getUDC_List_By_Ids_RT(lstSubChannelId, idRecTypeUDC) ){
          mapSubChannel.put(subChannel.Id, subChannel);
        }
    }
    ...
    if(listIdOwnerAccount.size() >0)
    {
        ...
        */
        List< UDC__c > lListReg = LAT_QueriesCacheHelper.getUDC_List_By_CodProd_CodUs_RT('01', '11', idRecTypeUDC);
        ...
        */
        List< UDC__c > lListNielsen = LAT_QueriesCacheHelper.getUDC_List_By_CodProd_CodUs_RT('01', '04', idRecTypeUDC);        
        ...
        */
        List< UDC__c > lListCidade = LAT_QueriesCacheHelper.getUDC_List_By_CodProd_CodUs_RT_Name('00', 'CT', idRecTypeUDC, lListCidadeName);
        ...
        */
        List< UDC__c > lListRegional = LAT_QueriesCacheHelper.getUDC_List_By_CodProd_CodUs_RT('01', '01', idRecTypeUDC); 
