trigger ASI_MFM_PO_BeforeUpdate on ASI_MFM_PO__c (before update) {
    ...
    // Tony Ren(elufa) 5Feb 2015
     ...
     // Tony Ren (elufa) 25Feb 2015
             ...
             Global_RecordTypeCache.getRt(trigger.new[0].recordTypeId).developerName.contains('ASI_MFM_PH') ||
             Global_RecordTypeCache.getRt(trigger.new[0].recordTypeId).developerName.contains('ASI_MFM_TW') ||
