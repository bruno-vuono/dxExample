...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>PR SSA Nigeria</description>
    <formFactors>Large</formFactors>
    <label>PR EUR NG SFA</label>
    ...
    <tabs>EUR_CRM_Auto_Number_Container__c</tabs>
    <tabs>EUR_CRM_Nigeria_Admin_Console</tabs>
    <tabs>EUR_CRM_Visit_Frequency_Criteria__c</tabs>
