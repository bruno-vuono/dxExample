...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>PR South Africa</description>
    <formFactors>Large</formFactors>
    <label>PR EUR ZA SFA</label>
    ...
    <tabs>EUR_CRM_Product_Discount_EU__c</tabs>
    ...
    <tabs>EUR_CRM_Model_Stock_Level__c</tabs>
    <tabs>EUR_CRM_Account_Volume_Tracker__c</tabs>
    <tabs>EUR_CRM_POSM_Order__c</tabs>
    <tabs>EUR_CRM_POSM_Order_Item__c</tabs>
    <tabs>EUR_ZA_South_Africa_Admin_Console</tabs>
