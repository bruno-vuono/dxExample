...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>false</active>
        <formula>AND(NOT(ISBLANK( QT_Bonus__c )), QT_Bonus__c &lt;&gt;0)</formula>
    ...
    <rules>
        ...
        <active>false</active>
        <formula>AND(NOT( ISBLANK(Percentual_de_bonus__c)),  OR(ISBLANK( QT_Bonus__c )), QT_Bonus__c =0)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>Backorder__c = 1</formula>
