...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Calcula bonificação percentual</fullName>
        <actions>
            <name>Atualiza_percentual_bonifica_o</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>AND(NOT(ISBLANK( LAT_QTBonus__c )), LAT_QTBonus__c &lt;&gt;0)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Calcula bonificação quantidade</fullName>
        <actions>
            <name>Atualiza_quantidade_bonificaao</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>AND(NOT( ISBLANK(LAT_PercentualOfBonus__c)),  OR(ISBLANK( LAT_QTBonus__c )), LAT_QTBonus__c =0)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Item em back order</fullName>
        <actions>
            <name>Atualiza_Oportunidade_em_backorder</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <description>Quando o item entra em back order agenda o alerta.</description>
        <formula>LAT_Backorder__c = 1</formula>
    ...
    <rules>
        <fullName>OLI_WF01_CopyDiscountToDiscountAR_AR</fullName>
        <actions>
            <name>OLI_DiscountAR1_AR</name>
            <type>FieldUpdate</type>
        </actions>
    ...
    <rules>
        <fullName>OLI_WF01_DiscountToZero_AR</fullName>
        <actions>
            <name>OLI_DiscountToZero_AR</name>
            <type>FieldUpdate</type>
        </actions>
