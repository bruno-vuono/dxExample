...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>RIC_NewAction_Notify</fullName>
        <actions>
            <name>RIC_Send_Tasks_After_Button_Click</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <description>Notify the &apos;Assigned To&apos; on the newly created Action if the related Project&apos; Status is &apos;Validé&apos;</description>
        <formula>ISPICKVAL(Project_Milestone__r.Project__r.RIC_Status__c, &apos;Validé&apos;)</formula>
    ...
    <rules>
        <fullName>RIC_Update_Task_Dates</fullName>
        <actions>
            <name>RIC_Update_Task_EndDate</name>
            <type>FieldUpdate</type>
        </actions>
        ...
        <active>false</active>
        <criteriaItems>
            <field>Milestone1_Task__c.RIC_ReEvaluate_WorkFlow_Value__c</field>
            <operation>equals</operation>
            <value>Update</value>
        </criteriaItems>
        <description>A workflow that updates the Start and End dates of a Task when importing a template</description>
        <triggerType>onCreateOnly</triggerType>
    </rules>
</Workflow>
