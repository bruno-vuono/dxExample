...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>ASI Pricing Approval Reminder for Forth Approver WF Rule</fullName>
        <active>false</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>ASI_Pricing_Approval__c.ASI_Pricing_Total_Approval_Levels__c</field>
            <operation>equals</operation>
            <value>4</value>
        </criteriaItems>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>ASI_Pricing_Approval_Reminder_for_Forth_Approver_Alert</name>
                <type>Alert</type>
            </actions>
            <actions>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Overdue_Pricing_Approval_Notification</name>
                <type>Alert</type>
            </actions>
    ...
    <rules>
        <fullName>Approval Request Reminder for First Approver</fullName>
        <active>false</active>
        <criteriaItems>
            <field>ASI_Pricing_Approval__c.ASI_Status__c</field>
            <operation>equals</operation>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Approval_Request_Reminder_for_First_Approver</name>
                <type>Alert</type>
            </actions>
            <actions>
                <name>Set_Reminder_Date</name>
    ...
    <rules>
        <fullName>Approval Request Reminder for Second Approver</fullName>
        <active>false</active>
        <criteriaItems>
            <field>ASI_Pricing_Approval__c.ASI_Status__c</field>
            <operation>equals</operation>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Approval_Request_Reminder_for_Second_Approver</name>
                <type>Alert</type>
            </actions>
            <actions>
                <name>Set_Reminder_Date</name>
    ...
    <rules>
        <fullName>Approval Request Reminder for Third Approver</fullName>
        <active>false</active>
        <criteriaItems>
            <field>ASI_Pricing_Approval__c.ASI_Status__c</field>
            <operation>equals</operation>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Approval_Request_Reminder_for_Third_Approver</name>
                <type>Alert</type>
            </actions>
            <actions>
                <name>Set_Reminder_Date</name>
