...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>RIC_Update_Milestone_Dates</fullName>
        <actions>
            <name>RIC_Update_Mile_EndDate</name>
            <type>FieldUpdate</type>
        </actions>
        ...
        <active>false</active>
        <criteriaItems>
            <field>Milestone1_Milestone__c.RIC_ReEvaluate_WorkFlow_Value__c</field>
            <operation>equals</operation>
            <value>Update</value>
        </criteriaItems>
        <description>A workflow that updates the Start and End dates of a Milestone when importing a template</description>
