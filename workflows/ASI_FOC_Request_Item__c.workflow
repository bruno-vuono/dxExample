...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <formula>IF(ISPICKVAL(  ASI_FOC_Request_Order__r.ASI_FOC_Request_Type__c , &quot;Return&quot; ), -1*ASI_FOC_SKU__r.ASI_FOC_Stock_Price__c *  ASI_FOC_Request_Quantity_Bottle__c, ASI_FOC_SKU__r.ASI_FOC_Stock_Price__c *  ASI_FOC_Request_Quantity_Bottle__c)</formula>
...
-1*ASI_FOC_SKU__r.ASI_FOC_Stock_Price__c *  ASI_FOC_Request_Quantity_PC__c, 
ASI_FOC_SKU__r.ASI_FOC_Stock_Price__c *  ASI_FOC_Request_Quantity_PC__c
)</formula>
