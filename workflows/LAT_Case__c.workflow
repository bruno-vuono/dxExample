...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <field>OwnerId</field>
        <lookupValue>segundo.galiano@pernod-ricard.com</lookupValue>
    ...
    <rules>
        <fullName>CSE_WF01_UpdateSubject_AR</fullName>
        <actions>
            <name>CSE_UpdateSubject_AR</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <description>Show type and reason.</description>
        <formula>(  $RecordType.DeveloperName=&apos;CSE_1_AccountAlteration_ARG&apos; ||  $RecordType.DeveloperName=&apos;CSE_2_AccountAlteration_URU&apos;  )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>CSE_WF07_UpdateRT_AR</fullName>
        <actions>
            <name>CSE_RTUpdate5_ARG</name>
            <type>FieldUpdate</type>
        </actions>
    ...
    <rules>
        <fullName>CSE_WF08_UpdateRT_UY</fullName>
        <actions>
            <name>CSE_RTUpdate5_UY</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>(  $RecordType.DeveloperName=&apos;CSE_2_AccountAlteration_URU&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueAccount_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueJustification_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueToAttorneys_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_PaymentProposal_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_UY&apos;  ) &amp;&amp;  ISPICKVAL(LAT_Type__c, &apos;Justificativa de inadimplência&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>CSE_WF09_UpdateRT_AR</fullName>
        <actions>
            <name>CSE_RTUpdate6_AR</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>(  $RecordType.DeveloperName=&apos;CSE_OverdueJustification_AR&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueAccount_AR&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueJustification_AR&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueToAttorneys_AR&apos; ||  $RecordType.DeveloperName=&apos;CSE_PaymentProposal_AR&apos; ||  $RecordType.DeveloperName=&apos;CSE_1_AccountAlteration_ARG&apos; ||  $RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_AR&apos;  )  &amp;&amp;  ISPICKVAL(LAT_Type__c, &apos;Proposta não realizada&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>CSE_WF10_UpdateRT_UY</fullName>
        <actions>
            <name>CSE_RTUpdate6_UY</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>(  $RecordType.DeveloperName=&apos;CSE_2_AccountAlteration_URU&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueAccount_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueJustification_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_OverdueToAttorneys_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_PaymentProposal_UY&apos; ||  $RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_UY&apos;  ) &amp;&amp;  ISPICKVAL(LAT_Type__c, &apos;Proposta não realizada&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Caso - envia para Controladoria</fullName>
        <actions>
            <name>altera_propriet_rio_Controladoria</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <description>Usado no processo de alteração de cadastro de cliente</description>
        <formula>ISPICKVAL(LAT_Status__c, &quot;Em análise - Controladoria&quot;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>AND ( $RecordType.Name = &quot;Alteração de cadastro de clientes&quot;, NOT(PRIORVALUE(LAT_IsClosed__c)), NOT(ISPICKVAL( LAT_Reason__c, &quot;Alt. transportadora&quot;)), NOT(ISPICKVAL( LAT_Reason__c, &quot;Alt. recebimento carga&quot;)), NOT(ISPICKVAL( LAT_Reason__c, &quot;Alt. tipo de frete&quot;)), NOT(ISPICKVAL( LAT_Reason__c, &quot;Alt. tipo de veículo&quot;)), NOT(ISPICKVAL( LAT_Reason__c, &quot;Alt. agendamento&quot;)), NOT(ISPICKVAL( LAT_Reason__c, &quot;Alt. paletização especial&quot;)), LAT_IsClosed__c, OR ( ISPICKVAL(Priorvalue( LAT_Status__c), &quot;Em análise - Crédito e cobrança&quot;), ISPICKVAL(Priorvalue( LAT_Status__c), &quot;Em análise - Planejamento Comercial&quot;), ISPICKVAL(Priorvalue( LAT_Status__c), &quot;Em análise - Customer Service&quot;) ), NOT(ISPICKVAL(LAT_Status__c, &quot;Reprovado&quot;)) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Prazo carta não renovação</fullName>
        <active>false</active>
        <formula>AND( ISPICKVAL(LAT_Type__c , &quot;Não Renovação de Contrato&quot;) ,  ISPICKVAL( LAT_Reason__c , &quot;Carta de não renovação de contrato&quot;), ISPICKVAL(LAT_Account__r.Channel__c, &quot;Off Trade&quot;),   LAT_Contract__r.Prazo_indeterminado__c )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
