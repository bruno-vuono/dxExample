...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>BMCServiceDesk__SDE_Emails/CCPE_Project_Charter_Approval_Received</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>BMCServiceDesk__SDE_Emails/CCPE_Project_Charter_Rejection_Received</template>
    </alerts>
    <fieldUpdates>
