...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>segundo.galiano@pernod-ricard.com</recipient>
            <type>user</type>
        </recipients>
    ...
    <alerts>
        ...
        <protected>false</protected>
        <recipients>
            <recipient>sebastian.nasta@pernod-ricard.com</recipient>
            <type>user</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/ACC_AccountErrorInJDE_AR</template>
...
if( Business_Unit__r.CodDefUsuario__c = &quot;17&quot;, &quot;149146&quot;,&quot;&quot;))))</formula>
    ...
    <rules>
        <fullName>ACC_WF08_UpdateRevenueCountry_AR</fullName>
        <actions>
            <name>UpdateRevenueCountry</name>
            <type>FieldUpdate</type>
        </actions>
    ...
    <rules>
        <fullName>ASI LUX - Birthday Reminder</fullName>
        <actions>
            <name>ASI_LUX_Birthday_Alert_Email</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <description>Birthday reminder: Send email to VIP manager to remind them on the morning on the actual birthday to call.</description>
        <formula>AND(  OR (IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;1&quot;) , IF(1=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;2&quot;) , IF(2=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;3&quot;) , IF(3=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;4&quot;) , IF(4=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;5&quot;) , IF(5=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;6&quot;) , IF(6=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;7&quot;) , IF(7=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;8&quot;) , IF(8=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;9&quot;) , IF(9=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;10&quot;) , IF(10=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;11&quot;) , IF(11=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;12&quot;) , IF(12=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;13&quot;) , IF(13=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;14&quot;) , IF(14=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;15&quot;) , IF(15=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;16&quot;) , IF(16=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;17&quot;) , IF(17=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;18&quot;) , IF(18=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;19&quot;) , IF(19=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;20&quot;) , IF(20=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;21&quot;) , IF(21=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;22&quot;) , IF(22=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;23&quot;) , IF(23=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;24&quot;) , IF(24=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;25&quot;) , IF(25=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;26&quot;) , IF(26=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;27&quot;) , IF(27=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;28&quot;) , IF(28=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;29&quot;) , IF(29=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;30&quot;) , IF(30=DAY(TODAY()),TRUE,FALSE),FALSE) , IF(ISPICKVAL(ASI_LUX_Birthday_Day__c , &quot;31&quot;) , IF(31=DAY(TODAY()),TRUE,FALSE),FALSE)  )  ,  OR( IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;January&quot;) , IF(1=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;February&quot;) , IF(2=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;March&quot;) , IF(3=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;April&quot;) , IF(4=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;May&quot;) , IF(5=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;June&quot;) , IF(6=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;July&quot;) , IF(7=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;August&quot;) , IF(8=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;September&quot;) , IF(9=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;October&quot;) , IF(10=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;November&quot;) , IF(11=MONTH(TODAY()),TRUE, FALSE), FALSE), IF(ISPICKVAL(ASI_LUX_Birthday_Month__c , &quot;December&quot;) , IF(12=MONTH(TODAY()),TRUE, FALSE), FALSE) )  )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>ASI LUX - Le Cercle Membership Anniversary Reminder</fullName>
        <actions>
            <name>ASI_LUX_Le_Cercle_Membership_Anniversary</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <description>Le Cercle Membership Anniversary Reminder: Send email to VIP manager to remind them on the morning on the actual anniversary to call.</description>
        <formula>IF(  AND( MONTH( TODAY()) = MONTH( ASI_LUX_LeCercle_Member_Since_Date__c ), DAY(TODAY()) = DAY( ASI_LUX_LeCercle_Member_Since_Date__c ), ASI_LUX_LeCercle_Member_Since_Date__c &lt;&gt; TODAY() ) , TRUE, FALSE)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>ASI LUX - Set Next Birthday</fullName>
        <actions>
            <name>ASI_LUX_Set_Next_Birthday</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        ...
        <criteriaItems>
            <field>Account.ASI_LUX_Birthday_Month__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>Account.RecordTypeId</field>
        ...
        <criteriaItems>
            <field>Account.RecordTypeId</field>
            <operation>notEqual</operation>
            <value>ASI Luxury Account (TW) - First Contact,ASI Luxury Account (TW) - Potential,ASI Luxury Account (TW) - Second Contact,ASI Luxury Account (TW) - Second Contact (Le Cercle Locked)</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>ASI_BRD_SG_Account_Record_Type_based_on_Lead_SG_GHM_Record_Type</fullName>
        <active>false</active>
        <criteriaItems>
            <field>Account.ASI_BRD_Converted_Lead_Record_Type__pc</field>
            <operation>startsWith</operation>
            <value>ASI_BRD_SG_GHM</value>
        </criteriaItems>
        <criteriaItems>
            <field>Account.RecordTypeId</field>
            <operation>equals</operation>
    ...
    <rules>
        <fullName>ASI_BRD_SG_Account_Record_Type_based_on_Lead_SG_TGL_Record_Type</fullName>
        <active>false</active>
        <criteriaItems>
            <field>Account.ASI_BRD_Converted_Lead_Record_Type__pc</field>
            <operation>startsWith</operation>
            <value>ASI_BRD_SG_TGL</value>
        </criteriaItems>
        <criteriaItems>
            <field>Account.RecordTypeId</field>
            <operation>equals</operation>
    ...
    <rules>
        <fullName>Atualiza banco e UF conforme UDC</fullName>
        <actions>
            <name>Atualiza_codigo_cidade_faturamento</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Atualiza_numero_banco</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Atualiza_pais_cob_com_end_usuario</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Atualiza_pais_com_end_usuario</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Atualiza_pais_ent_com_end_usuario</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Atualiza_uf_faturamento</name>
        ...
        <active>false</active>
        <formula>( $RecordType.DeveloperName=&apos;Eventos&apos;  || $RecordType.DeveloperName=&apos;Off_Trade&apos;  || $RecordType.DeveloperName=&apos;On_Trade&apos; )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Atualiza campos para maiusculos</fullName>
        <actions>
            <name>Alt_bairro_cobran_a_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_bairro_entrega_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_bairro_faturamento_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_logradouro_cobran_a_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_logradouro_entrega_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_logradouro_faturamento_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_nome_fantasia_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Alt_razao_social_upper</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>( $RecordType.DeveloperName=&apos;Eventos&apos;  || $RecordType.DeveloperName=&apos;Off_Trade&apos;  || $RecordType.DeveloperName=&apos;On_Trade&apos; )</formula>
    ...
    <rules>
        <fullName>Conferido - Controladoria</fullName>
        <actions>
            <name>Altera_status_Aprov_cadastro_no_JDE</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>( $RecordType.DeveloperName=&apos;Eventos&apos;  || $RecordType.DeveloperName=&apos;Off_Trade&apos;  || $RecordType.DeveloperName=&apos;On_Trade&apos; ) &amp;&amp; (Checked_over_Comptroller__c = true)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Conferido - Cred Cobrança</fullName>
        <actions>
            <name>Altera_status_Analise_planj_comercial</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>( $RecordType.DeveloperName=&apos;Eventos&apos;  || $RecordType.DeveloperName=&apos;Off_Trade&apos;  || $RecordType.DeveloperName=&apos;On_Trade&apos; ) &amp;&amp; (Checked_over_Credit_and_collection__c = true)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>LAT_MX_ACC_WF01_UpdateRevenueCountry</fullName>
        <actions>
            <name>LAT_MX_ACC_RevenueCountryUpdate</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <description>Updates Revenue Conutry to &apos;MX&apos; for Mexico records.</description>
        <formula>( $RecordType.DeveloperName=&apos;LAT_MX_ACC_OffTrade&apos; || $RecordType.DeveloperName=&apos;LAT_MX_ACC_OnTrade&apos; )</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
