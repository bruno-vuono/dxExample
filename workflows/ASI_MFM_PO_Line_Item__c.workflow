...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <actions>
            <name>ASI_MFM_Uncheck_POL_Synced_Flag</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ASI_MFM_Uncheck_PO_Synced_Flag_From_POL</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>ISCHANGED( LastModifiedDate ) &amp;&amp;  ASI_MFM_Synced__c &amp;&amp; !ISCHANGED (ASI_MFM_Synced__c)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <formula>AND(OR  (  ISNEW() , ISCHANGED(Name) ),NOT(CONTAINS(RecordType.DeveloperName, &quot;ASI_MFM_KR_PO&quot;)))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>ASI_MFM_Update_Base_Currency_Amount</fullName>
