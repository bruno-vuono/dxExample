...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>ASI_CRM_CN_Copy WS Manager Email</fullName>
        <actions>
        ...
        <active>false</active>
        <criteriaItems>
            <field>ASI_TH_CRM_PaymentRequest__c.ASI_CRM_Outlet_Fx__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <description>Copy WS Manager Email from Region</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>ASI_CRM_CN_Copy_Sales Email</fullName>
        <actions>
        ...
        <active>false</active>
        <criteriaItems>
            <field>ASI_TH_CRM_PaymentRequest__c.OwnerId</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <description>Copy Sales Email from Payment Request Onwer</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>ASI_CRM_CN_Send Email to Outlet%2FWS</fullName>
        <actions>
            <name>ASI_CRM_CN_Auto_Send_PaymentInstruction</name>
            <type>Alert</type>
        </actions>
        <actions>
            <name>ASI_CRM_CN_Sales_Email</name>
    ...
    <rules>
        <fullName>ASI_CRM_CN_Send Email to User</fullName>
        <actions>
            <name>ASI_CRM_CN_Auto_Send_PaymentInstruction_User</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>ASI_CRM_CN_PH_Payee_Line_Item__c.ASI_CRM_CN_ETL_Success__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <criteriaItems>
            <field>ASI_TH_CRM_PaymentRequest__c.ASI_CRM_CN_Promotion_Type__c</field>
            <operation>notEqual</operation>
            <value>New Contract ON,New Contract OFF</value>
        </criteriaItems>
        <description>ETL Success for Promotion Type except Contract ON OFF</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
