...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>EUR DK Competitor Contract expiring in 3 months</fullName>
        <active>false</active>
        <criteriaItems>
            <field>EUR_CRM_Contract_Tracker__c.RecordTypeId</field>
            <operation>equals</operation>
            <value>EUR DK Competitor Contract Tracker</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>EUR_DK_Send_Competitor_Contract_Expiration_Reminder</name>
                <type>Alert</type>
            </actions>
            <offsetFromField>EUR_CRM_Contract_Tracker__c.EUR_CRM_Contract_End_Date__c</offsetFromField>
            <timeLength>-90</timeLength>
