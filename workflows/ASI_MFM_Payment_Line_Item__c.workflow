...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>ASI_MFM_POSM_Deposit_Check</fullName>
        <actions>
            <name>ASI_MFM_PO_Line_POSM_Deposit_check</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>ASI_MFM_Payment_Line_Item__c.ASI_MFM_POSM_Deposit__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <criteriaItems>
            <field>ASI_MFM_Payment_Line_Item__c.RecordTypeId</field>
            <operation>equals</operation>
            <value>SG Payment Line Item,TH Payment Line Item</value>
        </criteriaItems>
        <criteriaItems>
