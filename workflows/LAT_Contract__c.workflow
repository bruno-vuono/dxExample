...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Aditamento gerado pelo jurídico</fullName>
        <actions>
            <name>Atualiza_status_contrato_aditamento</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Conferido_por_aditamento_gerado</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>LAT_Contract__c.Aditamento_gerado__c</field>
    ...
    <rules>
        <fullName>Assinado cliente</fullName>
        <actions>
            <name>Conferido_por_assinado_cliente</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>LAT_Contract__c.Ass_cliente__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        <fullName>Notifica expiração do contrato - Funcionalidade standard do Contract</fullName>
        <active>false</active>
        <criteriaItems>
            <field>LAT_Contract__c.Status__c</field>
            <operation>equals</operation>
        ...
        <description>Envia notificação ao proprietário da conta e contrato na data de vencimento do contrato.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>Contrato_ativo_vencendo_hoje</name>
                <type>Alert</type>
            </actions>
            <offsetFromField>LAT_Contract__c.EndDate__c</offsetFromField>
