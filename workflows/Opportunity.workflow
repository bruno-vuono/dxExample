...
LAT_MX_ClientPaymentPeriod__c))</formula>
    ...
    <rules>
        ...
        <formula>(RecordType.DeveloperName=&apos;Nova_oportunidade&apos; ||RecordType.DeveloperName=&apos;Bloqueia_alteracao_do_cabecalho&apos; ||RecordType.DeveloperName=&apos;Bloqueia_alteracao&apos;)  &amp;&amp;  ( AND(       Existe_item_em_backorder__c = 1,       PRIORVALUE(DT_delivery__c) &lt; DT_delivery__c,       NOT(ISNULL(DT_delivery__c))          ) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>(RecordType.DeveloperName=&apos;Nova_oportunidade&apos; ||RecordType.DeveloperName=&apos;Bloqueia_alteracao_do_cabecalho&apos; ||RecordType.DeveloperName=&apos;Bloqueia_alteracao&apos;)  &amp;&amp;  ( AND (        NOT(ISNULL(Data_Entrega_Recalculada__c)),        NOT(ISNULL(DT_delivery__c)),        DT_delivery__c  &lt; Data_Entrega_Recalculada__c ) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>(RecordType.DeveloperName=&apos;Nova_oportunidade&apos; ||RecordType.DeveloperName=&apos;Bloqueia_alteracao_do_cabecalho&apos; ||RecordType.DeveloperName=&apos;Bloqueia_alteracao&apos;)  &amp;&amp;  ( AND(        NOT(               ISPICKVAL(PRIORVALUE(StageName),&apos;Pedido com erro no JDE&apos;)                 ),        ISPICKVAL(StageName,&apos;Pedido com erro no JDE&apos;)          ) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
